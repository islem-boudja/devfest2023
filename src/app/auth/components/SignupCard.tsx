    ...
    return (
        <div className='sign-in-card sign-up-card rounded-xl w-1/2 min-h-90 bg-violet-900 px-16 pb-20'>
            ...
            <form className='sign-in-form' onSubmit={handleSubmit}>
                <input type="text" name="fullname" placeholder='Fullname' className='rounded-md p-2 my-3' onChange={(e) => setFullname(e.target.value)} />
                ...
                <button type='submit' className='sign-in-btn rounded-md text-white font-semibold w-72 mt-3 py-1 px-4'>Sign Up</button>
            </form>
